      ...
      <main className="px-6 md:px-12 pb-12">
        ...
        >
          ...
          <p className="mt-5 italic text-ink/65 text-xl max-w-2xl mx-auto font-serif leading-snug">
            DeBERTa-v3 · 8 heads · trained on 1.24M paired articles. The short, honest version.
          </p>
        </motion.section>
        ...
        <section className="pb-10">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            ...
            <Stat label="Pairs" value="1.24M" />
            <Stat label="Outlets" value="312" />
            <Stat label="Concordance" value="94.1%" />
          </div>
        </section>
        ...
        <Section>
          ...
          <Prose>
            <p>
              Most bias products score outlets. Reuters is "center", Fox is "right". Every
              article inherits the masthead's label. That's wrong. The same NYT byline can
              file a wire piece at -0.04 and an op-ed at +0.18. Outlet identity is branding,
              not text.
            </p>
            <p>
              I wanted something different: <span className="italic">comparison bias</span>.
              Pick a factual event covered by multiple outlets. Score each piece relative to
              the others. The Israeli airstrike is the same airstrike. What differs is which
              verbs the outlets reach for and which sources they quote first. Train on
              triples sampled from the same factual cluster. Penalise the model for scoring
              them identically.<Cite n={1} />
            </p>
            <p>
              A single left-right scalar also collapses information. Empirically there are
              four orthogonal political axes (economic, social, establishment, sensationalism)
              and three lexical signals (loaded language, source diversity, headline-body skew).
              So the model has 8 heads.
            </p>
          </Prose>
        </Section>
        ...
        <Section>
          ...
          <H2>1.24M paired articles. 312 outlets.</H2>
            ...
            <div className="md:col-span-6">
              <Prose>
                <p>
                  ...
                  embeddings<Cite n={6} /> (cosine ε = 0.18). Each cluster spans at
                  least three outlets across different bias buckets. Window:
                  2018-01 to 2025-11.
                </p>
                <p>
            ...
            <div className="md:col-span-7">
              <Prose>
                ...
                <p>
                  ...
                  on direction, <span className="font-mono">κ = 0.62</span> on loaded-span overlap.
                  6.4% went to a third annotator for adjudication.
                </p>
                <p>
            ...
            <div className="md:col-span-5 mt-8 md:mt-0">
              <Prose>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Stat label="Hardware" value="4× A100" />
                  <Stat label="Wall-clock" value="57.6 h" />
                  <Stat label="GPU spend" value="$312" />
                  <Stat label="Final loss" value="0.211" />
                </div>
                <p className="text-ink/65 italic">
                  HF Transformers 4.38, PyTorch 2.2 / CUDA 12.1, Lightning, DeepSpeed
                  ZeRO-2. Activation checkpointing on encoder layers (max_seq_len 1024
                  triplet forward otherwise OOMs).
                </p>
              </Prose>
            </div>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-12 md:gap-10 items-start">
            <div className="md:col-span-7">
              ...
              <p className="mt-5 font-serif text-[15px] italic leading-snug text-ink/65">
                <span className="not-italic font-semibold text-ink">94.1%</span>{' '}
                bias-direction concordance with AllSides on a 12,000-article cluster split.
                Split is by cluster, so the model never sees same-event coverage at train
                and test time.
              </p>
            </div>
            ...
            <div className="md:col-span-5 mt-8 md:mt-0">
              <Prose>
                <p>
                  ...
                  dynamic activation) on a single <SmallCaps>NVIDIA A10</SmallCaps> behind a
                  <SmallCaps> Modal</SmallCaps> endpoint. Quantisation cost 0.3 F1 and
                  bought 3.6× speedup.
                </p>
                <p>
                ...
                <p>
                  ...
                  is a separate beast: a smaller DistilRoBERTa bias model loads in your
                  browser via transformers.js. Real forward pass, not the production
                  DeBERTa. The lab is for transparency, not scoring.
                </p>
                <p className="text-ink/65">
                  Monitoring: Modal endpoint metrics, a Postgres ledger of every
                  inference (URL hash, scores, timestamp, model version), and a weekly
                  offline rerun of the held-out eval set against the live endpoint.
                </p>
              </Prose>
            </div>
          </div>
